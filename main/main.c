...
static const char *TAG = "quarklink-esp32-cellular";
static EventGroupHandle_t event_group = NULL;
static const int CONNECT_BIT = BIT0;
static const int GOT_DATA_BIT = BIT2;
static const int USB_DISCONNECTED_BIT = BIT3; // Used only with USB DTE but we define it unconditionally, to avoid too many #ifdefs in the code
const char *QUARKLINK_ENDPOINT = "cqtest.quarklink.io";
const uint16_t QUARKLINK_PORT = 6000;
const char *QUARKLINK_CERT =
    "-----BEGIN CERTIFICATE-----\r\n"
    "MIIBXjCCAQSgAwIBAgIIFmg86l64iQowCgYIKoZIzj0EAwIwEjEQMA4GA1UEAxMH\r\n"
    "T0VNUm9vdDAgFw0yMTAzMDExNDA0MDNaGA8yMDUxMDIyMjE0MDQwM1owEjEQMA4G\r\n"
    "A1UEAxMHT0VNUm9vdDBZMBMGByqGSM49AgEGCCqGSM49AwEHA0IABIOP7WuZ4gLA\r\n"
    "3Ep3bkiSk5dDDp7++R3PugD1Tq+TZYLRA7z/Z/9dL39BOmhT6fbIu9o/u74+HQqB\r\n"
    "A1vDiLkXUTGjQjBAMA4GA1UdDwEB/wQEAwIChDAPBgNVHRMBAf8EBTADAQH/MB0G\r\n"
    "A1UdDgQWBBQRDbWT68hCQKftHZfc3tVTA+/y0TAKBggqhkjOPQQDAgNIADBFAiEA\r\n"
    "vwFZ2Zb+JMI0+E4wF1FmMTj20LTPK7TnUz7nIzRViJoCIEdOZ4ebe4ZmFomfawDP\r\n"
    "nmGP2+liZqdwCJs115AyURd/\r\n"
    "-----END CERTIFICATE-----\r\n";
...
#error Invalid serial connection to modem.
    ...
    if (quarklink_init(&quarklink, QUARKLINK_ENDPOINT, QUARKLINK_PORT, QUARKLINK_CERT) == 0)
    {
        printf("Device ID = %s\n", quarklink.deviceID);
        quarklink_enrol(&quarklink);
    }
    ...
    while (1)
    {
        ...
        const esp_mqtt_client_config_t mqtt_cfg = {
            .broker.address.hostname = quarklink.iotHubEndpoint,
            .broker.address.port = quarklink.iotHubPort,
            .broker.address.transport = MQTT_TRANSPORT_OVER_SSL,
            .broker.verification.certificate = (const char *)quarklink.iotHubRootCert, //(const char *)server_cert_pem_start,
            .credentials = {
                .client_id = quarklink.deviceID,
                .authentication = {
                    .certificate = (const char *)quarklink.deviceCert,
                    .ds_data = &ds_data,
                },
            }};
